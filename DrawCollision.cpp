...
void DrawCollision::Update()
{
	Scene* scene = Manager::GetScene();

}

void DrawCollision::Draw()
{
	int d = 1;
...
void DrawCollision::SetDrawCollision(D3DXVECTOR3 pos, int num, D3DXVECTOR3 scale)
{
	m_Position = pos;
	m_CollNum = num;
	m_Scale = scale;
