...
void BULLETZIG::Update()
{
	...
	m_Count++;
	if ((m_Count >= 25) && (m_Count % 40 == 0))
	{
		for (int i = 0; i < BULLETZIG_OUTNUM; i++)
		{
			scene->AddGameObject<BULLET>(1)
				->SetTransform(m_Position,
					m_Rotation +
					D3DXVECTOR3(0.0f, i * (360/BULLETZIG_OUTNUM), 0.0f),
