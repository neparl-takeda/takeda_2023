...
void EFFECT::Draw()
{
	...
	vertex[0].Position = D3DXVECTOR3(-EXP_SIZE, EXP_SIZE, 0.0f);
	vertex[0].Normal = D3DXVECTOR3(0.0f, 0.0f, -1.0f);
	vertex[0].Diffuse = D3DXVECTOR4(1.0f, 1.0f, 1.0f, 1.0f);
	vertex[0].TexCoord = D3DXVECTOR2(x, y);

	vertex[1].Position = D3DXVECTOR3(EXP_SIZE, EXP_SIZE, 0.0f);
	vertex[1].Normal = D3DXVECTOR3(0.0f, 0.0f, -1.0f);
	vertex[1].Diffuse = D3DXVECTOR4(1.0f, 1.0f, 1.0f, 1.0f);
	vertex[1].TexCoord = D3DXVECTOR2(x + (1.0f/m_TexX), y);

	vertex[2].Position = D3DXVECTOR3(-EXP_SIZE, -EXP_SIZE, 0.0f);
	vertex[2].Normal = D3DXVECTOR3(0.0f, 0.0f, -1.0f);
	vertex[2].Diffuse = D3DXVECTOR4(1.0f, 1.0f, 1.0f, 1.0f);
	vertex[2].TexCoord = D3DXVECTOR2(x, y + (1.0f / m_TexY));

	vertex[3].Position = D3DXVECTOR3(EXP_SIZE, -EXP_SIZE, 0.0f);
