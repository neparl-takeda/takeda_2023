...
void ComponentMarker::Update()
{
	
}

void ComponentMarker::Draw()
{
	//入力レイアウト設定
...
void ComponentMarker::SetRotation(D3DXVECTOR3 rot)
{
	m_Rotation = rot;
}

void ComponentMarker::SetPosition(D3DXVECTOR3 pos)
{
	m_Position = pos;
}

void ComponentMarker::SetColor(D3DXCOLOR col)
{
	m_Color = col;
}